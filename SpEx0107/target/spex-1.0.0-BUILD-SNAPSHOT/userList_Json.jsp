	...
	function userInsert(){
		...
		$('#btnInsert').on('click',function(){
			$.ajax({ 
			    url: "users.do",  
			    type: 'POST',  
			    dataType: 'json', // @ResponseBody를 사용하였으면 dataType을 json으로.
			    data : $("#form1").serialize(),	// json 으로 받아오면 contentType에서도 json으로 .
			    //contentType: 'application/json', //@RequestBody를 사용하면 contentType을 json 으로.
